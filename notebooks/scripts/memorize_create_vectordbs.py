...
raw_triplets = list(kg_model.graph_db.execute_query(
...
for raw_triplet in tqdm(raw_triplets):
    ...
    triplet = TripletCreator.create(
        start_node, relation, end_node, add_stringified_triplet=False)
