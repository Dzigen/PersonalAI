...
def personaai_ru():
    ...
    config.textidstore_config.texttotriplets_store_config.db_config.db_info['db'] += 'RU'
    config.textidstore_config.triplettotexts_store_config.db_config.db_info['db'] += 'RU'
...
def personaai_en():
    ...
    config.textidstore_config.texttotriplets_store_config.db_config.db_info['db'] += 'EN'
    config.textidstore_config.triplettotexts_store_config.db_config.db_info['db'] += 'EN'
