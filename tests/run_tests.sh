...
# rerankers
pytest --cov=src.db_drivers.tree_driver --cov-report=html integrational/rerankers
mv htmlcov/ tmp_coverage_log/integrational/rerankers
...
docker stop personalai_mmenschikov_test_neo4j personalai_mmenschikov_test_mongo personalai_mmenschikov_test_redis personalai_mmenschikov_test_milvus personalai_mmenschikov_test_elasticsearch personalai_mmenschikov_test_opensearch
docker rm personalai_mmenschikov_test_neo4j personalai_mmenschikov_test_mongo personalai_mmenschikov_test_redis personalai_mmenschikov_test_milvus personalai_mmenschikov_test_elasticsearch personalai_mmenschikov_test_opensearch
