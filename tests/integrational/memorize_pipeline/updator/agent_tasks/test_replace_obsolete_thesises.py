...
@pytest.mark.parametrize("llm_stub_answer, base_triplet, lang, incident_triplets, expected_status, expected_output", [
    # нет замен
    (NO_THESIS_REPL_AGENT_ANSWER, HYPER_TRIPLET1, 'en', [
     HYPER_TRIPLET2, HYPER_TRIPLET3], ReturnStatus.success, []),
    # одна замена
    (ONE_THESIS_REPL_AGENT_ANSWER, HYPER_TRIPLET2, 'en', [
     HYPER_TRIPLET4, HYPER_TRIPLET3], ReturnStatus.success, [HYPER_TRIPLET4.id]),
    # несколько замен
    (SEVERAL_THESIS_REPL_AGENT_ANSWER, HYPER_TRIPLET3, 'en', [
     HYPER_TRIPLET4, HYPER_TRIPLET5], ReturnStatus.success, [HYPER_TRIPLET4.id, HYPER_TRIPLET5.id]),
    # ответ сгенерирован в неверном формате (parse error?)
    (BAD_THESIS_AGENT_ANSWER, HYPER_TRIPLET1, 'en', [
     HYPER_TRIPLET4, HYPER_TRIPLET3], ReturnStatus.success, []),
])
