...
@pytest.mark.parametrize("lang, base_triplet, incident_triplets, agent_stub_answers, expected_triplet_ids, expected_status", [
    ...
    ('ru', RU_VALID_SIMPLE_TRIPLET1, [RU_VALID_SIMPLE_TRIPLET2, RU_VALID_SIMPLE_TRIPLET3], [
     RU_MATCHED_OBOSLETE_TRIPELET_2], [RU_VALID_SIMPLE_TRIPLET2.id], ReturnStatus.success),
    # 1.1.2 найдена несколько устаревших связей
    ('ru', RU_VALID_SIMPLE_TRIPLET1, [RU_VALID_SIMPLE_TRIPLET2, RU_VALID_SIMPLE_TRIPLET3], [
     RU_MATCHED_OBSOLETE_TRIPLET_2AND3], [RU_VALID_SIMPLE_TRIPLET2.id, RU_VALID_SIMPLE_TRIPLET3.id], ReturnStatus.success),
    ...
    ('en', EN_VALID_SIMPLE_TRIPLET1, [EN_VALID_SIMPLE_TRIPLET2, EN_VALID_SIMPLE_TRIPLET3], [
     EN_MATCHED_OBOSLETE_TRIPELET_2], [EN_VALID_SIMPLE_TRIPLET2.id], ReturnStatus.success),
    # 2.1.2 найдена несколько устаревших связей
    ('en', EN_VALID_SIMPLE_TRIPLET1, [EN_VALID_SIMPLE_TRIPLET2, EN_VALID_SIMPLE_TRIPLET3], [
     EN_MATCHED_OBSOLETE_TRIPLET_2AND3], [EN_VALID_SIMPLE_TRIPLET2.id, EN_VALID_SIMPLE_TRIPLET3.id], ReturnStatus.success),
