...
RU_BAD_REPONSE_TRIPLET_2AND3 = '["кен апр", "кен мит"]'

EN_MATCHED_OBOSLETE_TRIPELET_2 = '["rty <- fgh"]'
EN_MATCHED_OBSOLETE_TRIPLET_2AND3 = '["rty <- fgh", "rty <- jkl"]'
...
def test_replace_thesis(replace_thesis_solver: AgentTaskSolver, lang: str, base_thesis: Triplet, incident_thesises: List[Triplet],
