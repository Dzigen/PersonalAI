...
@pytest.mark.parametrize("lang, text, rel_prop, agent_stub_answers, expected_triplets, expected_status", [
    # 1. русский язык
    # 1.1. позитивный тест
...
def test_extract_thesises(etriplets_solver: AgentTaskSolver, lang: str, text: str, rel_prop: Dict[str, object],
                          agent_stub_answers: List[str], expected_triplets: List[Triplet], expected_status: ReturnStatus):
