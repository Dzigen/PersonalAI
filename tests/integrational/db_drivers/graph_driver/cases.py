...
OBJECT_NODE1_2 = NodeCreator.create(
    name='abc', n_type=NodeType.object, prop={'k1_2': 'v1_2'})
...
EPISODIC_NODE1_2 = NodeCreator.create(
    name='uiop', n_type=NodeType.episodic, prop={'k7_2': 'v7_2'})
...
EPISODIC_TRIPLET1_2 = TripletCreator.create(start_node=OBJECT_NODE1, relation=Relation(
    name='episodic', type=RelationType.episodic), end_node=EPISODIC_NODE1_2)
...
GRAPHDB_CREATE_TEST_CASES = [
    ...
    # 3.2 thesis
    [[[THESIS_TRIPLET2]], [{0: FULL_CREATION_INFO}], {
        'exception': False, 'triplets_count': 1, 'nodes_count': 2}],
    # 3.3 episodic with object
    [[[EPISODIC_TRIPLET1]], [{0: FULL_CREATION_INFO}], {
        'exception': False, 'triplets_count': 1, 'nodes_count': 2}],
    # 3.4 episodic with thesis
    [[[EPISODIC_TRIPLET4]], [{0: FULL_CREATION_INFO}], {
        'exception': False, 'triplets_count': 1, 'nodes_count': 2}],
    # 4. добалвение одного триплета (только связь c заданным creation_info)
    # 4.1 simple rel
    [[[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], [SIMPLE_TRIPLET3]], [{0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, {
        0: ONLY_REL_CREATION_INFO}], {'exception': False, 'triplets_count': 3, 'nodes_count': 3}],
    # 4.2 hyper (object with thesis)
    [[[SIMPLE_TRIPLET2, THESIS_TRIPLET1], [THESIS_TRIPLET2]], [{0: FULL_CREATION_INFO, 1: FULL_CREATION_INFO}, {
        0: ONLY_REL_CREATION_INFO}], {'exception': False, 'triplets_count': 3, 'nodes_count': 4}],
    # 4.3 episodic (object with episodic)
    [[[SIMPLE_TRIPLET1, EPISODIC_TRIPLET1], [EPISODIC_TRIPLET2]], [{0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, {
        0: ONLY_REL_CREATION_INFO}], {'exception': False, 'triplets_count': 3, 'nodes_count': 3}],
    # 4.4 episodic (thesis with episodic)
    [[[EPISODIC_TRIPLET3, THESIS_TRIPLET3], [EPISODIC_TRIPLET4]], [{0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, {
        0: ONLY_REL_CREATION_INFO}], {'exception': False, 'triplets_count': 3, 'nodes_count': 3}],
    # 5. добавление одного триплета (связь и стартовая вершина c заданным creation_info)
    # 5.1 object -[simple]> object
    [[[SIMPLE_TRIPLET2], [SIMPLE_TRIPLET1]], [{0: FULL_CREATION_INFO}, {
        0: WO_EN_CREATION_INFO}], {'exception': False, 'triplets_count': 2, 'nodes_count': 3}],
    # 5.2 object -[hyper]> thesis
    [[[THESIS_TRIPLET2], [THESIS_TRIPLET1]], [{0: FULL_CREATION_INFO}, {
        0: WO_EN_CREATION_INFO}], {'exception': False, 'triplets_count': 2, 'nodes_count': 3}],
    # 5.3 object -[episodic]> episodic
    [[[EPISODIC_TRIPLET2], [EPISODIC_TRIPLET1]], [{0: FULL_CREATION_INFO}, {
        0: WO_EN_CREATION_INFO}], {'exception': False, 'triplets_count': 2, 'nodes_count': 3}],
    # 5.4 thesis -[episodic]> episodic
    [[[EPISODIC_TRIPLET3], [EPISODIC_TRIPLET4]], [{0: FULL_CREATION_INFO}, {
        0: WO_EN_CREATION_INFO}], {'exception': False, 'triplets_count': 2, 'nodes_count': 3}],
    # 6. добавление одного триплета (связь и конечная вершина c заданным creation_info)
    # 6.1 object <[simple]- object
    [[[SIMPLE_TRIPLET1], [SIMPLE_TRIPLET2]], [{0: FULL_CREATION_INFO}, {
        0: WO_SN_CREATION_INFO}], {'exception': False, 'triplets_count': 2, 'nodes_count': 3}],
    # 6.2 thesis <[hyper]- object
    [[[SIMPLE_TRIPLET1], [THESIS_TRIPLET1]], [{0: FULL_CREATION_INFO}, {
        0: WO_SN_CREATION_INFO}], {'exception': False, 'triplets_count': 2, 'nodes_count': 3}],
    # 6.3 episodic <[episodic]- object
    [[[SIMPLE_TRIPLET1], [EPISODIC_TRIPLET1]], [{0: FULL_CREATION_INFO}, {
        0: WO_SN_CREATION_INFO}], {'exception': False, 'triplets_count': 2, 'nodes_count': 3}],
    # 6.4 episodic <[episodic]- thesis
    [[[THESIS_TRIPLET3], [EPISODIC_TRIPLET4]], [{0: FULL_CREATION_INFO}, {
        0: WO_SN_CREATION_INFO}], {'exception': False, 'triplets_count': 2, 'nodes_count': 3}],
    ...
    [[[SIMPLE_TRIPLET1, THESIS_TRIPLET3]], [{0: FULL_CREATION_INFO, 1: FULL_CREATION_INFO}], {
        'exception': False, 'triplets_count': 2, 'nodes_count': 4}],
    # 7.3 hyper and episodic
    [[[THESIS_TRIPLET1, EPISODIC_TRIPLET2]], [{0: FULL_CREATION_INFO, 1: FULL_CREATION_INFO}], {
        'exception': False, 'triplets_count': 2, 'nodes_count': 4}],
...
for db_vendor in AVAILABLE_GRAPH_DBS:
    for i in range(len(GRAPHDB_CREATE_TEST_CASES)):
        GRAPHDB_POPULATED_CREATE_TEST_CASES.append(
            GRAPHDB_CREATE_TEST_CASES[i] + [db_vendor])
...
GRAPHDB_DELETE_TEST_CASES = [
    ...
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET3, THESIS_TRIPLET2, EPISODIC_TRIPLET2],
     {0: FULL_CREATION_INFO, 1: WO_EN_CREATION_INFO,
         2: WO_SN_CREATION_INFO, 3: WO_SN_CREATION_INFO},
     [SIMPLE_TRIPLET1.id, THESIS_TRIPLET2.id, EPISODIC_TRIPLET2.id],
     {0: {'s_node': False, 'e_node': False}, 1: {'s_node': False,
                                                 'e_node': True}, 2: {'s_node': True, 'e_node': True}},
     {'exception': False, 'triplets_count': 1, 'nodes_count': 2}],
...
for db_vendor in AVAILABLE_GRAPH_DBS:
    for i in range(len(GRAPHDB_DELETE_TEST_CASES)):
        GRAPHDB_POPULATED_DELETE_TEST_CASES.append(
            GRAPHDB_DELETE_TEST_CASES[i] + [db_vendor])
...
GRAPHDB_READ_TEST_CASES = [
    ...
    ], {'exception': False, 'output_ids': set()}],
    # 2. один существующий триплет
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, [
        SIMPLE_TRIPLET1.id], {'exception': False, 'output_ids': {SIMPLE_TRIPLET1.id}}],
    # 3. один несуществующий триплет
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, [
        SIMPLE_TRIPLET3.id], {'exception': False, 'output_ids': set()}],
    # 4. несколько существующих триплетов
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, [
        SIMPLE_TRIPLET1.id, SIMPLE_TRIPLET2.id], {'exception': False, 'output_ids': {SIMPLE_TRIPLET1.id, SIMPLE_TRIPLET2.id}}],
    # 5. в списке есть несуществующий идентификатор триплета
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, [
        SIMPLE_TRIPLET1.id, SIMPLE_TRIPLET3.id], {'exception': False, 'output_ids': {SIMPLE_TRIPLET1.id}}],
    # 6. неверный формат идентификатора 1
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, [
        123], {'exception': True, 'output_ids': set()}],
    # 7. неверный формат идентификатора 2
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, [
        True], {'exception': True, 'output_ids': set()}],
    # 8. неверный формат идентификатора 3
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, [
        None], {'exception': True, 'output_ids': set()}]
]

GRAPHDB_POPULATED_READ_TEST_CASES = []
for db_vendor in AVAILABLE_GRAPH_DBS:
    for i in range(len(GRAPHDB_READ_TEST_CASES)):
        GRAPHDB_POPULATED_READ_TEST_CASES.append(
            GRAPHDB_READ_TEST_CASES[i] + [db_vendor])
...
for db_vendor in AVAILABLE_GRAPH_DBS:
    for i in range(len(GRAPHDB_COUNT_TEST_CASES)):
        GRAPHDB_POPULATED_COUNT_TEST_CASES.append(
            GRAPHDB_COUNT_TEST_CASES[i] + [db_vendor])

###############################################################################################

GRAPHDB_EXIST_TEST_CASES = [
    # 1. элемент существует
    [[SIMPLE_TRIPLET1, EPISODIC_TRIPLET3], SIMPLE_TRIPLET1.id, {
        'exception': False, 'exist': True, 'type': 'triplet'}],
    # 2. элемента не существует
    [[SIMPLE_TRIPLET1, EPISODIC_TRIPLET3], 'unknown_id', {
        'exception': False, 'exist': False, 'type': 'triplet'}],
    # 3. неверный формат идентификатора # 1
    [[SIMPLE_TRIPLET1, EPISODIC_TRIPLET3], 789, {
        'exception': True, 'exist': False, 'type': 'triplet'}],
    # 4. неверный формат идентификатора # 2
    [[SIMPLE_TRIPLET1, EPISODIC_TRIPLET3], False, {
        'exception': True, 'exist': False, 'type': 'triplet'}],
    # 5. неверный формат идентификатора # 3
    [[SIMPLE_TRIPLET1, EPISODIC_TRIPLET3], None, {
        'exception': True, 'exist': False, 'type': 'triplet'}],
    # 6. Вершина существует
    [[SIMPLE_TRIPLET1, EPISODIC_TRIPLET3], OBJECT_NODE1.id, {
        'exception': False, 'exist': True, 'type': 'node'}],
    # 7. Вершины не существует
    [[SIMPLE_TRIPLET1, EPISODIC_TRIPLET3], OBJECT_NODE4.id, {
        'exception': False, 'exist': False, 'type': 'node'}]
]

GRAPHDB_POPULATED_EXIST_TEST_CASES = []
for db_vendor in AVAILABLE_GRAPH_DBS:
    for i in range(len(GRAPHDB_EXIST_TEST_CASES)):
        GRAPHDB_POPULATED_EXIST_TEST_CASES.append(
            GRAPHDB_EXIST_TEST_CASES[i] + [db_vendor])
...
for db_vendor in AVAILABLE_GRAPH_DBS:
    for i in range(len(GRAPHDB_CLEAR_TEST_CASES)):
        GRAPHDB_POPULATED_CLEAR_TEST_CASES.append(
            GRAPHDB_CLEAR_TEST_CASES[i] + [db_vendor])
...
GRAPHDB_GET_ADJECENT_TEST_CASES = [
    ...
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO},
        OBJECT_NODE1.id, ALL_N_TYPES, {'exception': False, 'output_ids': {OBJECT_NODE2.id}}],
    # 2. несколько смежных вершин
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, OBJECT_NODE2.id, ALL_N_TYPES, {
        'exception': False, 'output_ids': {OBJECT_NODE1.id, OBJECT_NODE3.id}}],
    # 3. несуществующий идентифкатор
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO},
        OBJECT_NODE4.id, ALL_N_TYPES, {'exception': False, 'output_ids': set()}],
    # 4. неверный формат идентификатора 1
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, 123, ALL_N_TYPES, {
        'exception': True, 'output_ids': set()}],
    # 5. неверный формат идентификатора 2
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, True, ALL_N_TYPES, {
        'exception': True, 'output_ids': set()}],
    # 6. неверный формат идентификатора 3
    [[SIMPLE_TRIPLET1, SIMPLE_TRIPLET2], {0: FULL_CREATION_INFO, 1: WO_SN_CREATION_INFO}, None, ALL_N_TYPES, {
        'exception': True, 'output_ids': set()}]
]
...
for db_vendor in AVAILABLE_GRAPH_DBS:
    for i in range(len(GRAPHDB_GET_TRIPLETS_TEST_CASES)):
        GRAPHDB_POPULATED_GET_TRIPLETS_TEST_CASES.append(
            GRAPHDB_GET_TRIPLETS_TEST_CASES[i] + [db_vendor])
...
GRAPHDB_READ_BY_NAME_TEST_CASES = [
    ...
    # бд пустая
    [[], dict(), {'triplets': 0, 'nodes': 0},
     THESIS_TRIPLET1.start_node.name, NodeType.object, 'node', [], False],
    # найден один объект
    [[THESIS_TRIPLET1, SIMPLE_TRIPLET1], {0: {'s_node': True, 'e_node': True}, 1: {'s_node': False, 'e_node': True}},
    ...
    [[], dict(), {'triplets': 0, 'nodes': 0}, "may existing name",
     RelationType.episodic, 'relation', [], False],
    # невалидный тип (type)
    [[EPISODIC_TRIPLET2], {0: {'s_node': True, 'e_node': True}},
...
for db_vendor in AVAILABLE_GRAPH_DBS:
    for i in range(len(GRAPHDB_READ_BY_NAME_TEST_CASES)):
        GRAPHDB_POPULATED_READ_BY_NAME_TEST_CASES.append(
            GRAPHDB_READ_BY_NAME_TEST_CASES[i] + [db_vendor])
...
for db_vendor in AVAILABLE_GRAPH_DBS:
    for i in range(len(GRAPHDB_GET_NSHARED_IDS_TEST_CASES)):
        GRAPHDB_POPULATED_GET_NSHARED_IDS_TEST_CASES.append(
            GRAPHDB_GET_NSHARED_IDS_TEST_CASES[i] + (db_vendor,))
