...
VALID_SUM_TNODE1 = TreeNode(
    id='123', text='qwe', type=TreeNodeType.summarized, props={'p1': 'k1', 'depth': 1})
VALID_SUM_TNODE2 = TreeNode(
    id='234', text='asd', type=TreeNodeType.summarized, props={'p2': 'k2', 'depth': 1})
VALID_SUM_TNODE3 = TreeNode(
    id='rgn', text='dggg', type=TreeNodeType.summarized, props={'p3': 'k3', 'depth': 1})
VALID_SUM_TNODE4 = TreeNode(id='ytjetmf', text='jrtdnf',
                            type=TreeNodeType.summarized, props={'p4': 'k4', 'depth': 1})
VALID_SUM_TNODE5 = TreeNode(id='sthbsfd', text='tendg',
                            type=TreeNodeType.summarized, props={'p5': 'k5', 'depth': 2})
VALID_SUM_TNODE6 = TreeNode(id='rthbdvae', text='sbfbsrga',
                            type=TreeNodeType.summarized, props={'p6': 'k6', 'depth': 3})
VALID_SUM_TNODE7 = TreeNode(id='yurkjda', text='sdfzbnts',
                            type=TreeNodeType.summarized, props={'p7': 'k7', 'depth': 2})
VALID_SUM_TNODE8 = TreeNode(id='dfvsdjtrtj', text='sxbfagrscv',
                            type=TreeNodeType.summarized, props={'p8': 'k8', 'depth': 2})

VALID_LEAF_TNODE1 = TreeNode(id='456', text='zxc', type=TreeNodeType.leaf, props={
                             'p1': 'k1', 'str_id': 'th5h6', 'depth': 2})
VALID_LEAF_TNODE2 = TreeNode(id='756', text='wer', type=TreeNodeType.leaf, props={
                             'p2': 'k2', 'str_id': 'ltutjgh', 'depth': 2})
VALID_LEAF_TNODE3 = TreeNode(id='hrtsfdb', text='agrdv', type=TreeNodeType.leaf, props={
                             'p3': 'k3', 'str_id': 'sbdvfvaa', 'depth': 2})
VALID_LEAF_TNODE4 = TreeNode(id='hbtrvv', text='sdgdbar', type=TreeNodeType.leaf, props={
                             'p4': 'k4', 'str_id': 'lagervfdbfd', 'depth': 2})

INVALID_LEAF_TNODE1 = TreeNode(
    id=123, text='dfhdf', type=TreeNodeType.leaf, props={'p3': 'k5', 'depth': 2})
INVALID_LEAF_TNODE2 = TreeNode(id="636", text='dfhdf', type="leaf", props={
                               'p3': 'k5', 'depth': 2})
INVALID_LEAF_TNODE3 = TreeNode(
    id="636", text=123, type=TreeNodeType.leaf, props={'p3': 'k5', 'depth': 2})
INVALID_LEAF_TNODE4 = TreeNode(
    id="636", text="123", type=TreeNodeType.leaf, props={123: 'k5', 'depth': 2})
INVALID_LEAF_TNODE5 = TreeNode(id="636", text="123", type=TreeNodeType.leaf, props={
                               "external_id": '636', 'depth': 2})

UPDATE_SUM_TNODE1 = TreeNode(id='123', text='qwe qwe', type=TreeNodeType.summarized, props={
                             'p1new': 'k1new', 'depth': 1})
UPDATE_LEAF_TNODE1 = TreeNode(id='456', text='zxc zxc', type=TreeNodeType.leaf, props={
                              'p1new': 'k1new', 'str_id': 'th5h6', 'depth': 2})
UPDATE_LEAF_TNODE1_TO_SUMM = TreeNode(
    id='456', text='zxc zxc rfv', type=TreeNodeType.summarized, props={'p1_1new': 'k1_1new', 'depth': 2})

UPDATE_INVALID_LEAF_TNODE1 = TreeNode(id='456', text='zxc zxc', type='leaf', props={
                                      'p1new': 'k1new', 'str_id': 'th5h6'})
UPDATE_INVALID_LEAF_TNODE2 = TreeNode(id=456, text='zxc zxc', type='leaf', props={
                                      'p1new': 'k1new', 'str_id': 'th5h6'})
UPDATE_INVALID_LEAF_TNODE3 = TreeNode(id='456', text=123, type='leaf', props={
                                      'p1new': 'k1new', 'str_id': 'th5h6'})
UPDATE_INVALID_LEAF_TNODE4 = TreeNode(
    id='456', text='zxc zxc', type='leaf', props={123: 'k1new', 'str_id': 'th5h6'})
UPDATE_INVALID_LEAF_TNODE5 = TreeNode(id='456', text='zxc zxc', type='leaf', props={
                                      'p1new': 'k1new', 'external_id': '456', 'str_id': 'th5h6'})
...
TREEDB_CREATE_TEST_CASES = [
    ...
    (["ROOT_NODE_ID", VALID_SUM_TNODE1.id], [
     VALID_LEAF_TNODE1, VALID_LEAF_TNODE2], [False, True]),
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_CREATE_TEST_CASES)):
        TREEDB_POPULATED_CREATE_TEST_CASES.append(
            TREEDB_CREATE_TEST_CASES[i] + (db_vendor,))
...
TREEDB_READ_TEST_CASES = [
    ...
    # 1.2. str_id
    ([("ROOT_NODE_ID", VALID_LEAF_TNODE1), ("ROOT_NODE_ID", VALID_LEAF_TNODE2)],
     [VALID_LEAF_TNODE1.props['str_id'],
         VALID_LEAF_TNODE2.props['str_id']], TreeIdType.str,
     {VALID_LEAF_TNODE1.id: VALID_LEAF_TNODE1, VALID_LEAF_TNODE2.id: VALID_LEAF_TNODE2}, False),
    # 2. невалидный тип
    ([("ROOT_NODE_ID", VALID_LEAF_TNODE1), ("ROOT_NODE_ID", VALID_LEAF_TNODE2)],
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_READ_TEST_CASES)):
        TREEDB_POPULATED_READ_TEST_CASES.append(
            TREEDB_READ_TEST_CASES[i] + (db_vendor,))
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_UPDATE_TEST_CASES)):
        TREEDB_POPULATED_UPDATE_TEST_CASES.append(
            TREEDB_UPDATE_TEST_CASES[i] + (db_vendor,))
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_DELETE_TEST_CASES)):
        TREEDB_POPULATED_DELETE_TEST_CASES.append(
            TREEDB_DELETE_TEST_CASES[i] + (db_vendor,))
...
TREEDB_COUNT_TEST_CASES = [
    ...
    ([["ROOT_NODE_ID", VALID_SUM_TNODE1]], {
     'leaf': 0, 'summarized': 1, 'root': 1}),
    # 2. нуль summed-элементов
    ([["ROOT_NODE_ID", VALID_LEAF_TNODE1], ["ROOT_NODE_ID", VALID_LEAF_TNODE2]], {
     'leaf': 2, 'summarized': 0, 'root': 1}),
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_COUNT_TEST_CASES)):
        TREEDB_POPULATED_COUNT_TEST_CASES.append(
            TREEDB_COUNT_TEST_CASES[i] + (db_vendor,))
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_EXIST_TEST_CASES)):
        TREEDB_POPULATED_EXIST_TEST_CASES.append(
            TREEDB_EXIST_TEST_CASES[i] + (db_vendor,))
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_CLEAR_TEST_CASES)):
        TREEDB_POPULATED_CLEAR_TEST_CASES.append(
            TREEDB_CLEAR_TEST_CASES[i] + (db_vendor,))
...
TREEDB_GETCHILDS_TEST_CASES = [
    ...
    # 2.1. один ребёнок
    # 2.1.1 leaf-элемент
    (TEST_TREE, VALID_SUM_TNODE3.id, {
     VALID_LEAF_TNODE2.id: VALID_LEAF_TNODE2}, False),
    # 2.1.2 summed-элемент
    (TEST_TREE, VALID_SUM_TNODE5.id, {
     VALID_SUM_TNODE6.id: VALID_SUM_TNODE6}, False),
    # 2.2. несколько детей
    # 2.2.1 все leaf-элементы
    (TEST_TREE, VALID_SUM_TNODE4.id, {
     VALID_LEAF_TNODE3.id: VALID_LEAF_TNODE3, VALID_LEAF_TNODE4.id: VALID_LEAF_TNODE4}, False),
    # 2.2.2 все summed-элементы
    (TEST_TREE, VALID_SUM_TNODE2.id, {
     VALID_SUM_TNODE7.id: VALID_SUM_TNODE7, VALID_SUM_TNODE8.id: VALID_SUM_TNODE8}, False),
    # 2.3 разные элементы
    (TEST_TREE, VALID_SUM_TNODE1.id, {
     VALID_LEAF_TNODE1.id: VALID_LEAF_TNODE1, VALID_SUM_TNODE5.id: VALID_SUM_TNODE5}, False),
    # 2.3. нуль детей
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_GETCHILDS_TEST_CASES)):
        TREEDB_POPULATED_GETCHILDS_TEST_CASES.append(
            TREEDB_GETCHILDS_TEST_CASES[i] + (db_vendor,))
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_GETMAXDEPTH_TEST_CASES)):
        TREEDB_POPULATED_GETMAXDEPTH_TEST_CASES.append(
            TREEDB_GETMAXDEPTH_TEST_CASES[i] + (db_vendor,))
...
for db_vendor in AVAILABLE_TREE_DBS:
    for i in range(len(TREEDB_GETLEAFDESCENDANTS_TEST_CASES)):
        TREEDB_POPULATED_GETLEAFDESCENDANTS_TEST_CASES.append(
            TREEDB_GETLEAFDESCENDANTS_TEST_CASES[i] + (db_vendor,))
