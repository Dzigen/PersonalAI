...
from src.parsers.memory_extraction import mem_custom_thesis_parse_func
...
def test_thesis_parse_func(raw_response, expected_triplets, expected_status):
    triplets, status = mem_custom_thesis_parse_func(raw_response)
