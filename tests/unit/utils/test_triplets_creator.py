...
TEST_OBJECT_NODE = NodeCreator.create(
    name=TEST_NODE_NAME, n_type=NodeType.object)
...
@pytest.mark.parametrize("params, expected", [
    ...
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_OBJECT_NODE, 'r_name': TEST_REL_NAME, 'r_prop': dict(
    ), 'id': None, 's_str': True}, {'str': TEST_EXPECTED_SIMPLE_TRIPLET_STR1}),
    # не сохранять строковое представление в триплете
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_OBJECT_NODE, 'r_name': TEST_REL_NAME,
     'r_prop': dict(), 'id': None, 's_str': False}, {'str': None}),
    # назначить собственный идентификатор триплету
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_OBJECT_NODE, 'r_name': TEST_REL_NAME,
     'r_prop': dict(), 'id': TEST_ID, 's_str': False}, {'str': None}),
    # строковое представление с отметкой времени
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_OBJECT_NODE, 'r_name': TEST_REL_NAME, 'r_prop': TEST_PROPS_WITH_TIME,
     'id': None, 's_str': True}, {'str': TEST_EXPECTED_SIMPLE_TRIPLET_WITH_TIME_STR2}),
    # строкое представление со свойствами
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_OBJECT_NODE, 'r_name': TEST_REL_NAME,
     'r_prop': TEST_PROPS_WO_TIME, 'id': None, 's_str': True}, {'str': TEST_EXPECTED_SIMPLE_TRIPLET_STR3}),
    # строкоове представление без свойств/имён
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_OBJECT_NODE, 'r_name': '', 'r_prop': dict(
    ), 'id': None, 's_str': True}, {'str': TEST_EXPECTED_SIMPLE_TRIPLET_STR4}),
    # строковое представление со специальными свойствами
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_OBJECT_NODE, 'r_name': TEST_REL_NAME, 'r_prop': TEST_PROPS_WITH_SPECIAL,
     'id': None, 's_str': True}, {'str': TEST_EXPECTED_SIMPLE_TRIPLET_WITH_TIME_STR2}),
])
def test_create_simple_triplet(params, expected):
    rel = Relation(name=params['r_name'],
                   prop=params['r_prop'], type=RelationType.simple)
...
TEST_THESIS_NODE1 = NodeCreator.create(
    name=TEST_NODE_NAME, n_type=NodeType.hyper)
TEST_THESIS_NODE2 = NodeCreator.create(
    name=TEST_NODE_NAME, n_type=NodeType.hyper, prop=TEST_PROPS_WITH_TIME)
TEST_THESIS_NODE3 = NodeCreator.create(
    name=TEST_NODE_NAME, n_type=NodeType.hyper, prop=TEST_PROPS_WO_TIME)
TEST_THESIS_NODE4 = NodeCreator.create(
    name=TEST_NODE_NAME, n_type=NodeType.hyper, prop=TEST_PROPS_WITH_SPECIAL)
...
@pytest.mark.parametrize("params, expected", [
    # сохранить строковое представление в триплете
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_THESIS_NODE1, 'r_name': TEST_REL_NAME,
     'r_prop': dict(), 'id': None, 's_str': True}, {'str': TEST_EXPECTED_HYPER_TRIPLET_STR1}),
    # не сохранять строковое представление в триплете
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_THESIS_NODE1, 'r_name': TEST_REL_NAME,
     'r_prop': dict(), 'id': None, 's_str': False}, {'str': None}),
    # назначить собственный идентификатор триплету
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_THESIS_NODE1, 'r_name': TEST_REL_NAME,
     'r_prop': dict(), 'id': TEST_ID, 's_str': False}, {'str': None}),
    # строковое представление с отметкой времени
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_THESIS_NODE2, 'r_name': TEST_REL_NAME,
     'r_prop': TEST_PROPS_WO_TIME, 'id': None, 's_str': True}, {'str': TEST_EXPECTED_HYPER_TRIPLET_STR2}),
    # строкое представление со свойствами
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_THESIS_NODE3, 'r_name': TEST_REL_NAME,
     'r_prop': TEST_PROPS_WO_TIME, 'id': None, 's_str': True}, {'str': TEST_EXPECTED_HYPER_TRIPLET_STR3}),
    # строкоове представление без свойств/имён
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_THESIS_NODE1, 'r_name': '', 'r_prop': dict(
    ), 'id': None, 's_str': True}, {'str': TEST_EXPECTED_HYPER_TRIPLET_STR1}),
    # строковое представление со специальными свойствами
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_THESIS_NODE4, 'r_name': TEST_REL_NAME,
     'r_prop': TEST_PROPS_WITH_SPECIAL, 'id': None, 's_str': True}, {'str': TEST_EXPECTED_HYPER_TRIPLET_STR2}),
])
def test_create_hyper_triplet(params, expected):
    rel = Relation(name=params['r_name'],
                   prop=params['r_prop'], type=RelationType.hyper)
    triplet = TripletCreator.create(
        start_node=params['sn'], relation=rel,
        end_node=params['en'], add_stringified_triplet=params['s_str'],
        t_id=params['id'])
...
TEST_EPISODIC_NODE1 = NodeCreator.create(
    name=TEST_NODE_NAME, n_type=NodeType.episodic)
TEST_EPISODIC_NODE2 = NodeCreator.create(
    name=TEST_NODE_NAME, n_type=NodeType.episodic, prop=TEST_PROPS_WITH_TIME)
TEST_EPISODIC_NODE3 = NodeCreator.create(
    name=TEST_NODE_NAME, n_type=NodeType.episodic, prop=TEST_PROPS_WO_TIME)
TEST_EPISODIC_NODE4 = NodeCreator.create(
    name=TEST_NODE_NAME, n_type=NodeType.episodic, prop=TEST_PROPS_WITH_SPECIAL)
...
@pytest.mark.parametrize("params, expected", [
    # сохранить строковое представление в триплете
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_EPISODIC_NODE1, 'r_name': TEST_REL_NAME,
     'r_prop': dict(), 'id': None, 's_str': True}, {'str': TEST_EXPECTED_EPISODIC_TRIPLET_STR1}),
    # не сохранять строковое представление в триплете
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_EPISODIC_NODE1, 'r_name': TEST_REL_NAME,
     'r_prop': dict(), 'id': None, 's_str': False}, {'str': None}),
    # назначить собственный идентификатор триплету
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_EPISODIC_NODE1, 'r_name': TEST_REL_NAME,
     'r_prop': dict(), 'id': TEST_ID, 's_str': False}, {'str': None}),
    # строковое представление с отметкой времени
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_EPISODIC_NODE2, 'r_name': TEST_REL_NAME,
     'r_prop': TEST_PROPS_WO_TIME, 'id': None, 's_str': True}, {'str': TEST_EXPECTED_EPISODIC_TRIPLET_STR2}),
    # строкое представление со свойствами
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_EPISODIC_NODE3, 'r_name': TEST_REL_NAME,
     'r_prop': TEST_PROPS_WO_TIME, 'id': None, 's_str': True}, {'str': TEST_EXPECTED_EPISODIC_TRIPLET_STR3}),
    # строкоове представление без свойств/имён
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_EPISODIC_NODE1, 'r_name': '', 'r_prop': dict(
    ), 'id': None, 's_str': True}, {'str': TEST_EXPECTED_EPISODIC_TRIPLET_STR1}),
    # строковое представление со специальными свойствами
    ({'sn': TEST_OBJECT_NODE, 'en': TEST_EPISODIC_NODE4, 'r_name': TEST_REL_NAME,
     'r_prop': TEST_PROPS_WITH_SPECIAL, 'id': None, 's_str': True}, {'str': TEST_EXPECTED_EPISODIC_TRIPLET_STR2}),
])
def test_create_episodic_triplet(params, expected):
    rel = Relation(name=params['r_name'],
                   prop=params['r_prop'], type=RelationType.episodic)
    triplet = TripletCreator.create(
        start_node=params['sn'], relation=rel,
        end_node=params['en'], add_stringified_triplet=params['s_str'],
        t_id=params['id'])
...
NODE_OBJECT_FULL_PROP = NodeCreator.create(
    n_type=NodeType.object, name='rty', prop={'k1': 'v1'})

RELATION_SIMPLE_EMPTY_PROP = RelationCreator.create(
    r_type=RelationType.simple, name='uio')
...
TRIPLET_HYPER_WITH_OMITED_NAME = TripletCreator.create(
    start_node=NodeCreator.create(
        name=NODE_OBJECT_OMITED_PROP['name'], n_type=NODE_OBJECT_OMITED_PROP['type'],),
...
TRIPLET_EPISODIC_WITH_OMITED_NAME = TripletCreator.create(
    ...
    relation=RelationCreator.create(
        r_type=RELATION_EPISODIC_OMITED_NAME['type']),
...
@pytest.mark.parametrize("json_triplet, expected_triplet, exception", [
    ...
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_OBJECT_OMITED_PROP}, TRIPLET_EMPTY_PROP, False),
    # 1.2. не заполнено name-поле
    # 1.2.1 type = 'object'
    ({'subject': NODE_OBJECT_OMITED_NAME, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_OBJECT_OMITED_PROP}, None, True),
    # 1.2.2 type = 'hyper'
    ({'subject': NODE_HYPER_OMITED_NAME, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_OBJECT_OMITED_PROP}, None, True),
    # 1.2.3 type = 'episodic'
    ({'subject': NODE_EPISODIC_OMITED_NAME, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_OBJECT_OMITED_PROP}, None, True),
    # 1.3. не заполнено type-поле
    ({'subject': NODE_OBJECT_OMITED_TYPE, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_OBJECT_OMITED_PROP}, None, True),
    # 1.4. указано невалидное значение в type-поле
    ({'subject': NODE_OBJECT_BAD_TYPE, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_OBJECT_OMITED_PROP}, None, True),
    # 2. В relation
    ...
    # 2.2.1 type = 'simple'
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_SIMPLE_OMITED_NAME,
     'object': NODE_OBJECT_OMITED_PROP, }, None, True),
    # 2.2.2 type = 'hyper'
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_HYPER_OMITED_NAME,
     'object': NODE_HYPER_OMITED_PROP}, TRIPLET_HYPER_WITH_OMITED_NAME, False),
    # 2.2.3 type = 'episodic'
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_EPISODIC_OMITED_NAME,
     'object': NODE_EPISODIC_OMITED_PROP}, TRIPLET_EPISODIC_WITH_OMITED_NAME, False),
    # 2.3. не заполнено type-поле
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_SIMPLE_OMITED_TYPE,
     'object': NODE_OBJECT_OMITED_PROP}, None, True),
    # 2.4. указано невалидное значение в type-поле
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_SIMPLE_BAD_TYPE,
     'object': NODE_OBJECT_OMITED_PROP, }, None, True),
    # 3. В object
    ...
    # 3.2.1 type = 'object'
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_OBJECT_OMITED_NAME}, None, True),
    # 3.2.2 type = 'hyper'
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_HYPER_OMITED_NAME}, None, True),
    # 3.2.3 type = 'episodic'
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_EPISODIC_OMITED_NAME}, None, True),
    # 3.3. не заполнено type-поле
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_OBJECT_OMITED_TYPE}, None, True),
    # 3.4. указано невалидное значение в type-поле
    ({'subject': NODE_OBJECT_OMITED_PROP, 'relation': RELATION_SIMPLE_OMITED_PROP,
     'object': NODE_OBJECT_BAD_TYPE}, None, True),
])
