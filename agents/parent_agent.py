...
VPS_IP = "146.0.73.157"
port = 8000
API_KEY = "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" 
...
class GPTagent:
    ...
    def item_processing_scores1(self, text):
        prompt = "####\n" + \
             "You are a retriever part of the agent system that solve some problem.\n" + \
             "You will be provided with agents' difficulties which may be appeared while solving problem.\n" + \
