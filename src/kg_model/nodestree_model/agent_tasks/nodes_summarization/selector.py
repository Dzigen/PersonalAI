...
from .....utils.data_structs import LogLevel
...
class AgentSummNTaskConfigSelector:
    ...
    def select(base_config_version: str = 'v1',
               cache_table_name: str = "qa_agent_summn_task_cache",
               inferencestat_table_name: str = "qa_agent_summn_task_stat",
