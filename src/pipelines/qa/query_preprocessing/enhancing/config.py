...
DEFAULT_QEXPAN_TASK_CONFIG = AgentQueryExpansionCheckConfigSelector.select(base_config_version='v1')
DEFAULT_TCHECK_TASK_CONFIG = AgentQueryTermsCheckConfigSelector.select(base_config_version='v1')
DEFAULT_LCHECK_TASK_CONFIG = AgentQueryLinguistCheckConfigSelector.select(base_config_version='v1')
