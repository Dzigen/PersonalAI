...
4. If [Question] have no vague, colloquial, or incorrect terms, then return it as is without changes.
...
4. Если в [Question] нет неясных, разговорных или некорректных терминов, верните его как есть, без изменений.
