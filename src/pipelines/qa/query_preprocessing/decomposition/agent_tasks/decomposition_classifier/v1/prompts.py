...
RU_DC_SYSTEM_PROMPT = \
    '''
Вы должны определить: можно ли разбить заданный вопрос на несколько независимых простых вопросов, на которые можно ответить независимо друг от друга. Сгенерируйте «True» или «False».
