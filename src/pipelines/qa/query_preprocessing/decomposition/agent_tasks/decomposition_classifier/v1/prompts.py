...
RU_DC_SYSTEM_PROMPT = \
    '''
Вам должны определить: можно ли разбить заданный вопрос на несколько независимых простых вопросов, на которые можно ответить независимо друг от друга. Сгенерируйте «Да» или «Нет».
...
[Answer]
<окончательный ответ>
, где <цепочка рассуждений> — это ваш путь рассуждений, основанный на заданном вопросе и приводящий к ответу, а <окончательный ответ> — ваш Да/Нет-ответ.
'''
