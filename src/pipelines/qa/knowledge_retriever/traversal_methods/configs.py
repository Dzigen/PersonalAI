...
ASTAR_RETRIEVER_LOG_PATH = 'log/qa//knowledge_retriever/astar_retriever'
BEAMSEARCH_RETRIEVER_LOG_PATH = 'log/qa/knowledge_retriever/beamsearch_retriever'
WATERCIRCLES_RETRIEVER_LOG_PATH = 'log/qa/knowledge_retriever/watercircles_retriever'
NAIVEBFS_RETRIEVER_LOG_PATH = 'log/qa/knowledge_retriever/naivebfs_retriever'
NAIVE_RETRIEVER_LOG_PATH = 'log/qa/knowledge_retriever/naive_retriever'
MIXTURED_RETRIEVER_LOG_PATH = 'log/qa/knowledge_retriever/mixtured_retriever'
