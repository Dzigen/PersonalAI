...
from .parsers import en_csubasumm_custom_answer_parse, ru_csubasumm_custom_answer_parse
...
EN_CSUBASUMM_SUITE = AgentTaskSuite(
    ...
    parse_answer_func=en_csubasumm_custom_answer_parse
)
...
RU_CSUBASUMM_SUITE = AgentTaskSuite(
    ...
    parse_answer_func=ru_csubasumm_custom_answer_parse
)

CSUBASUMM_SUITE_V1 = {'ru': RU_CSUBASUMM_SUITE, 'en': EN_CSUBASUMM_SUITE}
