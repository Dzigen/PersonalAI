...
from .parsers import ssubasumm_custom_answer_parse
...
EN_SSUBASUMM_SUITE = AgentTaskSuite(
    ...
    parse_answer_func=ssubasumm_custom_answer_parse
)
...
SSUBASUMM_SUITE_V3 = {'ru': RU_SSUBASUMM_SUITE, 'en': EN_SSUBASUMM_SUITE}
