...
from ......prompts.qa_pipeline.answer_generator.question_answering import \
    EN_AG_SYSTEM_PROMPT, EN_AG_USER_PROMPT, EN_AG_ASSISTANT_PROMPT, \
...
ANSWER_GENERATION_LOG_PATH = 'log/qa/kg_reasoner/weak/answer_generation/task'
