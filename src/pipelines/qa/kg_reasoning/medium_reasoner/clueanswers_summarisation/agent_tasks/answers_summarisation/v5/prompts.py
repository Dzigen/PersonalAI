...
3. The answer must be generated only for the given [Question]. If some auxiliary question has no required information, this does NOT automatically mean that there is no information for the original [Question].
...
[Finded Information]
Cant find requested information
[Chain of thoughts #2]
...
3. Ответ нужно сгенерировать только на заданный вопрос [Question]. Если на какой-то вспомогательный вопрос нет нужной информации - это НЕ означает, что автоматически нет информации и на исходный вопрос [Question].
4. Сохраняйте точные числа, единицы измерения и даты.
5. Не добавляйте домыслов, которых нет в источнике.
6. Выводите только блоки [Chain of thoughts] и [Answer] - ничего кроме этого не генерируйте.
...
[Finded Information]
Не удалось найти запрашиваемую информацию.
[Chain of thoughts #2]
