...
RU_CASUMM_SYSTEM_PROMPT = \
    '''
При наличии вопроса, связанных с ним поисковых запросов и найденной на их основе информации вам предлагается ответить на вопрос, основываясь только на этих знаниях. Если в найденной информации нет релевантной информации для формирования подходящего ответа, необходимо сгенерировать следующее: "<|NotEnoughtInfo|>". Перед формированием ответа необходимо представить свою цепочку рассуждений.

Формат, который необходимо использовать для формирования ответа, представлен ниже:
[Chain of thoughts]
<цепочка рассуждений>
[Answer]
<финальный ответ>
,где <цепочка рассуждений> — это ваш путь рассуждений, основанный на заданном вопросе, поисковых запросах и найденной информации, который приводит к ответу, а <финальный ответ> — ваш окончательный ответ на вопрос.
'''
