...
4. Do not make inferences or generalizations that are not in the source. Do not add assumptions.
5. Output only the [Relevant Summary] section. Do not generate anything else.
...
[Relevant Summary] - a brief summary of the relevant facts.
...
4. Не делайте выводов и обобщений, которых нет в источнике. Не добавляйте домыслов.
5. Выводите только секцию [Relevant Summary]. Ничего кроме этого не генерируйте.
...
[Relevant Summary] - краткое обобщение релевантных фактов.
