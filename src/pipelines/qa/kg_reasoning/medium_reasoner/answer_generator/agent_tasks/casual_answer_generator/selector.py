...
class AgentCasualAnswerGeneratorTaskConfigSelector(BaseAgentTaskConfigSelector):
    @staticmethod
    ...
    def select(base_config_version: str = 'v2',
        ...
        return AgentTaskSolverConfig(
            ...
            suites=AVAILABLE_CANSWGEN_TCONFIGS[base_config_version],
            formate_context_func=canswgen_custom_formate, postprocess_answer_func=canswgen_custom_postprocess,
            cache_table_name=cache_table_name,
            inferencestat_table_name=inferencestat_table_name,
            log_path=CANSWGEN_LOG_PATH,
