...
5. Do not add assumptions or conclusions that are not in the source.
...
5. Не добавляйте домыслов и выводов, которых нет в источнике.
