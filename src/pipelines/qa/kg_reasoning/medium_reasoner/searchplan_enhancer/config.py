...
DEFAULT_PLANINIT_TASK_CONFIG = AgentPlanInitTaskConfigSelector.select(
    base_config_version='v1')
DEFAUL_ENHCLASSIFY_TASK_CONFIG = AgentEnhanceClassifierTaskConfigSelector.select(
    base_config_version='v1')
DEFAULT_PLANENH_TASK_CONFIG = AgentPlanEnhancingTaskConfigSelector.select(
    base_config_version='v1')
