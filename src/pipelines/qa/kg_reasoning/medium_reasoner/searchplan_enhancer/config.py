...
from .agent_tasks.searchstop_classifier import AgentSearchStopClassifierTaskConfigSelector
...
SPENH_AGENTASKS_SELECTORS_MAPPING: Dict[str, BaseAgentTaskConfigSelector] = {
    ...
    'searchstop_classifier': AgentSearchStopClassifierTaskConfigSelector
}
