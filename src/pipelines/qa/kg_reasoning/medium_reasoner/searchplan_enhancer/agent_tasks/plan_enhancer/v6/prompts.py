...
10. If "Existing search-plan is complited. Next search-steps need to be planned.", then generate new search steps, which must be executed to get information for accurate answer generation on given [Question], and add them to [Enhanced next search-plan queries].
...
What country is Carl Boese from?
What country is Curtis Bernhardt from?
...
What is the place of birth of Gu Changwei?
'''
...
10. Если "Existing search-plan is complited. Next search-steps need to be planned.", то сгенерируйте новые шаги поиска, которые необходимо выполнить для получения информации для генерации точного ответа на заданный [Question], и добавьте их в [Enhanced next search-plan queries].
...
[Enhanced next search-plan queries #2]
Из какой страны родом Кертис Бернхардт?
Из какой страны Карл Боэзе?
