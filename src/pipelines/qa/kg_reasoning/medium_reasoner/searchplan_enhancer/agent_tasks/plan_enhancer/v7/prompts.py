...
10. If "Existing search-plan is complited. Next search-steps need to be planned." in [Next search-plan queries at now], then generate new search steps, which must be executed to get information for accurate answer generation on given [Question], and add them to [Enhanced next search-plan queries].
