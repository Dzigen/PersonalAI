...
def searchscls_custom_formate(query: str, search_steps: List[str], steps_answers: List[str]) -> Dict[str, str]:
...
def searchscls_custom_postprocess(parsed_response: str, **kwargs) -> bool:
