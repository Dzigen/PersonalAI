...
8. If "Existing search-plan is complited. Next search-steps need to be planned.", then return 'True' as [Answer].
...
8. Если "Existing search-plan is complited. Next search-steps need to be planned.", то верните 'True' в качестве [Answer].
