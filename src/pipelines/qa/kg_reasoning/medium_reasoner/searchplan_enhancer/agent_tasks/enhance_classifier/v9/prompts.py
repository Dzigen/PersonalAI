...
[Next search-plan queries at now] - the next search queries from the search plan or "<|NoSearchSteps|>" at the current moment.
...
[Next search-plan queries at now] - следующие поисковые запросы из плана поиска или "<|NoSearchSteps|>" на данный момент.
