...
class SearchPlanEnhancerAgentTasksConfig(BaseAgentTasksConfig):
    ...
    :param enhance_classifier: Конфигурация атомарной задачи для LLM-агента по определению необходимости (бинарная классификация) модификации существующего плана поиска. Значение по умолчанию 'v7'.
    :type enhance_classifier: AgentTaskSolverConfig, optional
    :param plan_enhancing: Конфигурация атомарной задачи для LLM-агента по подификации/перегенерации не пройденных шагов поиска в рамках существующего плана. Значение по умолчанию 'v7'.
    ...
    enhance_classifier: Union[AgentTaskSolverConfig, str] = 'v7'
    plan_enhancing: Union[AgentTaskSolverConfig, str] = 'v7'
