...
class Entities2NodesMatcherConfig:
    ...
    :param distance_threshold: Пороговое значение семантического расстояния между сущностью и вершинами в графе, по которому выполняется отсечение нерелевантных объектов (вершин). Значение по умолчанию 0.4.
