...
class KuzuTreeConnector(AbstractTreeDatabaseConnection):
    ...
    def formate_nodes_output(self, output: QueryResult) -> List[TreeNode]:
        formated_nodes = []
        ...
        for i in range(nodes_count):
            ...
            cur_f_node = TreeNode(
                id=raw_node['external_id'], text=raw_node['text'], type=node_type)
            if raw_node['props'] is not None:
                cur_f_node.props = dict(raw_node['props'])
