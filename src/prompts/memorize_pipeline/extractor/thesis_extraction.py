RU_THESISES_EXTRACTION_SYSTEM_PROMPT = '''Задача: Основная цель - тщательно собрать информацию из входного текста и организовать эти данные в четкий, структурированный граф знаний.
...
EN_THESISES_EXTRACTION_SYSTEM_PROMPT = '''Objective: The main goal is to meticulously gather information from input text and organize this data into a clear, structured knowledge graph.
...
RU_THESISES_EXTRACTION_USER_PROMPT = '''Текст: {text}
...
EN_THESISES_EXTRACTION_USER_PROMPT = '''Text: {text}
