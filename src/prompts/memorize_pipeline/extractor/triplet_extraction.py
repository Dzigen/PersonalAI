...
RU_TRIPLETS_EXTRACTION_SYSTEM_PROMPT = '''Задача: Основная цель - скрупулезно собрать информацию из текста и организовать эти данные в четкий, структурированный граф знаний.
...
EN_TRIPLETS_EXTRACTION_SYSTEM_PROMPT = '''Objective: The main goal is to meticulously gather information from the text and organize this data into a clear, structured knowledge graph.
...
RU_TRIPLETS_EXTRACTION_USER_PROMPT = '''Текст: {text}
...
EN_TRIPLETS_EXTRACTION_USER_PROMPT = '''Text: {text}
