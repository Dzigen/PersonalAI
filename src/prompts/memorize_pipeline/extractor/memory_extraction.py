triplet_extraction_prompt = '''Objective: The main goal is to meticulously gather information from the text and organize this data into a clear, structured knowledge graph.
...
thesis_extraction_prompt = '''Objective: The main goal is to meticulously gather information from input text and organize this data into a clear, structured knowledge graph.
...
Между отдельными частями наблюдений могут существовать связи. Например, если в начале наблюдения говорится, что вы находитесь в локации, а в конце - что есть выход на восток, тебе следует извлечь триплет: 'Локация, имеет выход на, восток'.
...
"Альберт Эйнштейн родился в Германии; ['Альберт Эйнштейн', 'Германия']. Альберт Эйнштейн разработал теорию относительности; ['Альберт Ейнштейн', 'Теория относительности']».
