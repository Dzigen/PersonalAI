...
- models/ - каталог с нейросетевыми моделями (используем DVC для версионирования и совместного использования)
- data/ - каталог с датасетами/базми данных (используем DVC для версионирования и совместного использования)
