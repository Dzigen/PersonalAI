...
print("triplets_dict", len(triplets_dict), "inters_chains1", len(inters_chains1), "inters_chains2", len(inters_chains2))
...
def process_inters_chains(inters_chains1, inters_chains2):
    ...
    for chain, cnt in inters_chains1:
        chain_subj_obj1, chain_triplets1 = process_chain(chain, chain_subj_obj1, chain_triplets1, cnt)
    for chain1, chain2, *_ in inters_chains2:
        chain_subj_obj2, chain_triplets2 = process_chain(chain1, chain_subj_obj2, chain_triplets2, 0)
        chain_subj_obj2, chain_triplets2 = process_chain(chain2, chain_subj_obj2, chain_triplets2, 0)
