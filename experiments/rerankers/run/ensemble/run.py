print("Start EnsembleReranker evaluation...")
import sys
import joblib
import yaml
...
from src.rerankers.methods.EnsembleFusionReranker import EnsembleFusionReranker, EnsembleFusionRerankerConfig, RetrieverConfig
...
RAW_ENSEMBLE_CONFIG = EXP_PARAMS['ensemble_fusion_config']
retriever_configs = [
    RetrieverConfig(fetch_n=raw_config['fetch_n'], threshold=raw_config['threshold']) 
    for raw_config in RAW_ENSEMBLE_CONFIG['retriever_configs']]

reranker_config = EnsembleFusionRerankerConfig(
    vdb_names=RAW_ENSEMBLE_CONFIG['vdb_names'],
    retriever_configs=retriever_configs,
    weights=RAW_ENSEMBLE_CONFIG['weights'],
    c=RAW_ENSEMBLE_CONFIG['c']
)

print("EnsembleFusionConfig:")
...
reranker = EnsembleFusionReranker(
