...
RAGAS_EVALUATE_SCRIPT="$BASE_EVALUATE_DIR/evaluate_ragas.py"
...
RAGASEVALUATE_LOG_PATH="$SPEC_EXP_DIR/ragaseval_log.txt"
...
# cd $SPEC_EXP_DIR ; $PYTHON_CMD $RAGAS_EVALUATE_SCRIPT $QAHYPERP_PARAMS_PATH $EXPDIR_PARAMS_PATH $EVAL_PARAMS_PATH >> $RAGASEVALUATE_LOG_PATH 2>&1
