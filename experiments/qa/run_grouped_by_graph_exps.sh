...
#
DATASETS=("2wikimultihopqa_dev" "hotpotqa_distractor_validation" "diaasq" "musique_validation" "natural_questions_train" "trivia_qa_rcwikipedia_validation")  # TO CHANGE
#  
KNOWLEDGE_GRAPHS=("qwen257b_080226_v2prompts" "qwen257b_230126_v2prompts" "qwen257b_260126_v2prompts" "qwen257b_050226_v2prompts" "qwen257b_020226_v2prompts"  "qwen257b_290126_v2prompts")  # TO CHANGE
#
EVAL_FNAMES=("2wikimultihopqa_dev.yaml" "hotpotqa_distractor_validation.yaml" "diaasq.yaml" "musique_validation.yaml" "natural_questions_train.yaml" "trivia_qa_rcwikipedia_validation.yaml")  # TO CHANGE
#
CONFIGURE_FNAMES=("2wikimultihopqa_dev.yaml" "hotpotqa_distractor_validation.yaml" "diaasq.yaml" "musique_validation.yaml" "natural_questions_train.yaml" "trivia_qa_rcwikipedia_validation.yaml") # TO CHANGE
# "weak" "medium"
