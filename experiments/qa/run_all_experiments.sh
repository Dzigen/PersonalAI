...
exp_names[0]="weak_bs_gigachat(e1)(v2.1.0)"
...
do
    ...
    QAHYPERP_PARAMS_PATH="$CONFIGURE_BASE_DIR/$QAPIPELINE_KW/$PREPARED_PARAMS_NAME/$DATASET_NAME/$KNOWLEDGEGRAPH_NAME/${exp_hyperp[$exp_idx]}"
