...
KGENV_FILE_PATH = f"{SPEC_KG_PATH}/{QAENV_PARAMS['KG_SETTING_DI']['name']}/{QAENV_PARAMS['KG_SETTING_DI']['kgenv']}"
with open(KGENV_FILE_PATH, 'r') as stream:
    KGENV_PARAMS = yaml.safe_load(stream)

# Read YAML file (kgconn-file)
KGCONN_FILE_PATH = f"{SPEC_KG_PATH}/{QAENV_PARAMS['KG_SETTING_DI']['name']}/{QAENV_PARAMS['KG_SETTING_DI']['kgconn']}"
...
CONTAINER_EXP_PATH = f"{QAENV_PARAMS['BASE_PERSONALAI_PATH']}/{KGENV_PARAMS['WORKSPACE_CONTAINER_DIRS']['experiments']}"
SAVE_PARAMS_PATH = f"{CONTAINER_EXP_PATH}/{KGENV_PARAMS['SAVE_PARAMS_CONFIG']['base_path']}/{QAENV_PARAMS['DATASET_NAME']}/{QAENV_PARAMS['KNOWLEDGE_GRAPH_NAME']}"
...
redis_cnt_variables = {
    ...
    'REDIS_CONFIG': f"{QAENV_PARAMS['BASE_PERSONALAI_PATH']}/{KGENV_PARAMS['PERSONALAI_REPO_DIRS']['configs']}/{ADDITIONAL_DC_PARAMS['redis_config_name']}"
}
...
milvus_cnt_variables = {
    ...
    'MILVUS_CONFIG': f"{QAENV_PARAMS['BASE_PERSONALAI_PATH']}/{KGENV_PARAMS['PERSONALAI_REPO_DIRS']['configs']}/{ADDITIONAL_DC_PARAMS['milvus_config_name']}"
}
...
llmagents_cnt_variables = {
    ...
    'OLLAMA_EXTERNAL_PORT': QAENV_PARAMS['OLLAMA_EXT_PORT'].get('port', 11437),
