...
WORKSPACE_CNTNAME=personalai_mmenschikov_analogues_kgbuild_workspace\_$METHOD\_$DATASET_NAME\_$KG_NAME

# -----------------------------------------------------------

LOCAL_BASE_PATH=/mnt/data/m.menschikov/personalai/knowledge_graphs/analogues_eval # TO CHANGE

LOCAL_METHOD_ENVFILE_PATH="$LOCAL_BASE_PATH/$METHOD/$DATASET_NAME/$KG_NAME/$ENVFILE_NAME"
LOCAL_METHOD_ENVSETTINGS_PATH="$TMP_BASE_DIR/$METHODS_EVAL_REL_PATH/$METHODS_CUSTOM_UTILS_DIR/$METHOD/$METHOD_ENVSETTING_DIR"
...
docker exec -u root $WORKSPACE_CNTNAME $PYTHON_CMD "$WORKSPACE_KGCONFIGURE_DIR/prepare_method_config.py" $WORKSPACE_KGCONN_PARAMS_PATH $WORKSPACE_KGENV_PARAMS_PATH $WORKSPACE_KGHYPERP_PARAMS_PATH
