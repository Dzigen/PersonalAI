...
workspace_cnt_variables = {
    ...
    'EXTERNAL_SPEC_QADS_PATH': f"{EXT_PA_PATH}/{KGENV_PARAMS['PERSONALAI_REPO_DIRS']['datasets']}/{KGHYPERP_PARAMS['DATASET_NAME']}",
    ...
    'INTERNAL_SPEC_QADS_PATH': f"{INT_PA_PATH}/{KGENV_PARAMS['WORKSPACE_CONTAINER_DIRS']['datasets']}/{KGHYPERP_PARAMS['DATASET_NAME']}",
