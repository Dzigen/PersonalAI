...
LOCAL_METHOD_KGS_PATH=f"{KGENV_PARAMS['LOCAL_KG_PATH']}/{KGHYPERP_PARAMS['METHOD_NAME']}"
LOCAL_SPEC_KG_PATH = f"{LOCAL_METHOD_KGS_PATH}/{KGHYPERP_PARAMS['DATASET_NAME']}/{KGHYPERP_PARAMS['KNOWLEDGE_GRAPH_NAME']}"

TMP_METHODS_KGS_PATH=f"{KGENV_PARAMS['TMP_WORKSPACE_PERSONALAI_PATH']}/{KGENV_PARAMS['WORKSPACE_CONTAINER_DIRS']['kg']}/{KGHYPERP_PARAMS['METHOD_NAME']}"
...
CONTAINERS_NAME_POSTFIX=f"{KGHYPERP_PARAMS['METHOD_NAME']}_{KGHYPERP_PARAMS['DATASET_NAME']}_{KGHYPERP_PARAMS['KNOWLEDGE_GRAPH_NAME']}"
...
EXT_PA_PATH = KGENV_PARAMS['TMP_WORKSPACE_PERSONALAI_PATH']
...
workspace_cnt_variables = {
    ...
    'EXTERNAL_SPEC_DS_PATH': f"{EXT_PA_PATH}/{KGENV_PARAMS['WORKSPACE_CONTAINER_DIRS']['datasets']}/{KGHYPERP_PARAMS['DATASET_NAME']}",
    'EXTERNAL_NOTEBOOKS_PATH': f"{EXT_PA_PATH}/{KGENV_PARAMS['WORKSPACE_CONTAINER_DIRS']['notebooks']}",
    'EXTERNAL_EXPERIMENTS_PATH': f"{EXT_PA_PATH}/{KGENV_PARAMS['WORKSPACE_CONTAINER_DIRS']['experiments']}",
    ...
    'INTERNAL_SPEC_KG_PATH': f"{INT_PA_PATH}/{KGENV_PARAMS['WORKSPACE_CONTAINER_DIRS']['kg']}/{KGHYPERP_PARAMS['METHOD_NAME']}/{KGHYPERP_PARAMS['DATASET_NAME']}/{KGHYPERP_PARAMS['KNOWLEDGE_GRAPH_NAME']}",
...
compose_variables = {
    'COMPOSE_PROJECT_NAME': f"personalai_mmenshikov_kgbuild_{CONTAINERS_NAME_POSTFIX}"
}

method_custom_env_variables = AVAILABLE_GRAPHRAG_BUILD_METHODS[KGHYPERP_PARAMS['METHOD_NAME']].prepare_kgbuild_env_params(KGCONN_PARAMS, KGENV_PARAMS, KGHYPERP_PARAMS)
