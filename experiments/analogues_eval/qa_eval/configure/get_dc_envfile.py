...
sys.path.insert(0, "../../../")
from available_methods_utils.config import AVAILABLE_GRAPHRAG_QA_METHOD
...
CONTAINER_KG_PATH = f"{QAENV_PARAMS['BASE_PERSONALAI_PATH']}/{QAENV_PARAMS['WORKSPACE_CONTAINER_DIRS']['kg']}/{SPEC_ENV_RELPATH}"
...
SPEC_KG_PATH = f"{QAENV_PARAMS['BASE_KG_PATH']}/{SPEC_ENV_RELPATH}"
...
workspace_cnt_variables = {
    ...
    'EXTERNAL_SPEC_DS_PATH': f"{EXT_PA_PATH}/{KGENV_PARAMS['PERSONALAI_REPO_DIRS']['datasets']}/{QAENV_PARAMS['DATASET_NAME']}",
