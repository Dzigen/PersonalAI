...
def plot_accuracy_histogram(acc_dict: Dict[str, List[int]], color_map: Dict[str, str], save_path: str) -> None:
    ...
    # plt.show()
    plt.savefig(f"{save_path}/accuracy_histogram.pdf", format="pdf")
